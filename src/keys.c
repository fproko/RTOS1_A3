...
//dbn_t key_n1 = {TEC1, STATE_KEY_UP, EVENT_KEY_NONE, KEYS_INVALID_TIME, KEYS_INVALID_TIME, KEYS_INVALID_TIME};
//dbn_t key_n2 = {TEC2, STATE_KEY_UP, EVENT_KEY_NONE, KEYS_INVALID_TIME, KEYS_INVALID_TIME, KEYS_INVALID_TIME};
//dbn_t key_n3 = {TEC3, STATE_KEY_UP, EVENT_KEY_NONE, KEYS_INVALID_TIME, KEYS_INVALID_TIME, KEYS_INVALID_TIME};
//dbn_t key_n4 = {TEC4, STATE_KEY_UP, EVENT_KEY_NONE, KEYS_INVALID_TIME, KEYS_INVALID_TIME, KEYS_INVALID_TIME};
